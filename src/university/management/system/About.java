...
public class About extends JFrame {
    About(){
        ...
        JLabel heading = new JLabel("<html>Presidency University</html>");
        heading.setBounds(70,20,300,130);
        heading.setFont(new Font("Tahoma", Font.BOLD,30));
        add(heading);

        JLabel name = new JLabel("Presidency University");
        name.setBounds(60,260,550,40);
        name.setFont(new Font("Tahoma", Font.BOLD,30));
        add(name);

        JLabel contact = new JLabel("PresidencyUniversity@gmail.com");
